...
// Редактор подсказок анкеты — необязательное дополнение к "о себе": до
// MAX_PROMPTS пар "вопрос из каталога + короткий ответ". С подсказками у
// мэтча сразу есть, с чего начать разговор, но можно обойтись и без них.
//
// Props:
//   value    — [{ code, answer }]
    ...
    <div className="prompts-editor">
      {value.length === 0 && (
        <p className="muted prompts-editor__hint">
          Можно пропустить, а можно ответить на пару вопросов — с ними легче начать разговор.
        </p>
      )}
